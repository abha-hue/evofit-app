...
export default function Moodboard() {
  ...
  return (
    <section className="py-section-gap bg-deep-black" id="moodboard">
      <div className="px-gutter max-w-container-max mx-auto">
        <div className="mb-stack-lg">
          <h2 className="font-display-xl text-headline-lg-mobile md:text-headline-lg uppercase text-pure-white leading-none">
            INSIDE <span className="text-impact-orange italic">EVOFIT</span>
          </h2>
          <p className="font-body-lg text-body-lg text-on-secondary-container max-w-xl mt-4">
            A glimpse into the grit, execution, and environment where champions are forged daily.
          </p>
        </div>
        ...
        <div
          ref={containerRef}
          className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 h-auto md:h-[900px] relative"
        >
          {/* Card 1 (Large Square) */}
          <div
          ...
          {/* Card 2 (Small Square) */}
          <div
            className="bento-card md:col-span-1 md:row-span-1 relative overflow-hidden bg-surface-grey border-2 border-surface-container-highest cursor-pointer z-1"
          ...
          {/* Card 3 (Vertical Tall) */}
          <div
            className="bento-card md:col-span-1 md:row-span-2 relative overflow-hidden bg-surface-grey border-2 border-surface-container-highest cursor-pointer z-1"
          ...
          >
            <div
              className="bento-img w-full h-full bg-cover bg-center"
              style={{
                backgroundImage: "url('/mood5.jpg')",
              }}
            ></div>
          </div>

          {/* Card 5 (Wide Horizontal) */}
          <div
            className="bento-card md:col-span-4 md:row-span-1 relative overflow-hidden bg-surface-grey border-2 border-surface-container-highest cursor-pointer z-1"
            onMouseEnter={() => handleMouseEnter(4)}
            onMouseLeave={handleMouseLeave}
          >
            <div
              className="bento-img w-80 h-full bg-contain bg-center"
              style={{
                backgroundImage: "url('/mood4.jpg')",
              }}
            ></div>
            <div className="absolute inset-0 bg-gradient-to-t from-deep-black via-transparent to-transparent opacity-80 pointer-events-none"></div>
            <div className="absolute bottom-6 left-6 pointer-events-none">
